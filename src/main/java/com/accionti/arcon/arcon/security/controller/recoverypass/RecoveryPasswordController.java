package com.accionti.arcon.arcon.security.controller.recoverypass;

import com.accionti.arcon.arcon.dto.email.EmailDto;
import com.accionti.arcon.arcon.models.user.User;
import com.accionti.arcon.arcon.security.controller.dtos.UpdatePasswordDto;
...
@RestController
@RequestMapping("/api-arcon/recovery/")
@CrossOrigin(origins = {"*"})
        ...
        if (user != null) {
            ...
            if (updatePasswordDto.getSecretPass().equals(user.getSecretPass())) {
                ...
                emailService.sendMail(new EmailDto(
                        ...
                        "Se ha actualizado correctamente la contraseña de tu cuenta para el sistema ARCON de AccionTI"
                ));
                return new ResponseEntity<>(
